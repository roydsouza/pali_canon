#!/usr/bin/env python3
"""
SN 22 (Khandhasaṃyutta) atthakathā layer from CSCD (Sāratthappakāsinī).

SN 22 is in the Khandavagga (s0303). The file is s0303a.att0.xml.
"""
