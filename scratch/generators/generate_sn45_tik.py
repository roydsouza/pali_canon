#!/usr/bin/env python3
"""
SN 45 (Maggasaṃyutta) tika layer from CSCD (Sāratthappakāsinī-ṭīkā).
File is s0305t.tik0.xml.
"""
...
SAMYUTTA = {
    ...
    "commentary_name":  "Sāratthappakāsinī-ṭīkā (Saṃyutta Nikāya Ṭīkā)",
    "cscd_file":        "s0305t.tik0.xml",
}
...
def build_tik_file(s, pali_body, para_count, cscd_file):
    ...
    att_link  = f"[[{slug}_att|{pali_title}vaṇṇanā (Commentary)]]"
