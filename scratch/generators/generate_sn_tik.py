#!/usr/bin/env python3
"""
SN 46 (Bojjhaṅgasaṃyutta) and SN 54 (Ānāpānasaṃyutta) tīkā layer
from CSCD (Sāratthappakāsinī-ṭīkā).

  SN 46 tīkā:  s0305t.tik1.xml  (entire file = SN 46)
  SN 54 tīkā:  s0305t.tik9.xml  (entire file = SN 54)
"""
