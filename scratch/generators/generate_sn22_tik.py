#!/usr/bin/env python3
"""
SN 22 (Khandhasaṃyutta) tīkā layer from CSCD (Sāratthappakāsinī-ṭīkā).

SN 22 is in the Khandavagga (s0303). The file is s0303t.tik0.xml.
"""
