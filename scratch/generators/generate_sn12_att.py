#!/usr/bin/env python3
"""
SN 12 (Nidānasaṃyutta) atthakathā layer from CSCD (Sāratthappakāsinī).

SN 12 is in the Nidānavagga (s0302). The file is s0302a.att0.xml.
"""
