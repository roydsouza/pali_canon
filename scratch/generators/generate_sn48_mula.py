#!/usr/bin/env python3
"""
SN 48 (Indriyasaṃyutta) mūla layer — selected suttas.
20 key suttas on the Five Spiritual Faculties.
"""
...
SAMYUTTA = {
    ...
    "tags": ["faculties", "indriya", "faith", "energy", "mindfulness", "concentration", "wisdom"],
}
...
def build_samyutta_file(s, sutta_blocks, selected_count):
    ...
    header = "\n".join([
        ...
        "",
        f"*Selected suttas ({selected_count} of 149): including Suddhika (sn48.1), "
        f"Sotāpanna (sn48.2), Arahanta (sn48.4), Samaṇabrāhmaṇa (sn48.6), Daṭṭhabba (sn48.8), "
        f"Vibhaṅga (sn48.9-10), Paṭilābha (sn48.11), Saṅkhitta (sn48.12), Jīvitindriya (sn48.22), "
        f"Aññindriya (sn48.23), Jarādhamma (sn48.41), Uṇṇābha (sn48.42), Pubbakoṭṭhaka (sn48.44), "
        f"Āpaṇa (sn48.50), Sāla (sn48.51), Sekha (sn48.53), Pada (sn48.54), Patiṭṭhita (sn48.56), and Sūkarakhata (sn48.58).*",
        "",
        "---",
        "",
    ])
