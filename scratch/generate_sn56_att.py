#!/usr/bin/env python3
"""
SN 56 (Saccasaṃyutta) atthakathā layer from CSCD (Sāratthappakāsinī).

SN 56 is the 12th saṃyutta of the Mahāvagga (s0305). File: s0305a.att11.xml.
"""
