...
tags:
  ...
  - samadhi
parallels:
  - 'MA 76 (ma76) · Chinese · 郁伽支羅'
  - 'SN 47.3 (sn47.3) · Pali · Bhikkhusutta'
---
...
> | kappessasī (?) | ? |  |
> | ṭhassantī (?) | ? |  |
> | anubandhitabba | ptp | should be followed (by); should be trailed (by) |
> | ajjhesan (?) | ? |  |
> | panidhekacca | pron | and here a certain; but here some |
> | ṭhassati | fut | will stand; will stay; will remain; will last |
> | gagghati | fut | will go; will walk; will wander around |
> | savitakkampi (?) | ? |  |
> | assan (?) | ? |  |
> | mamaññeva | sandhi | just me |
> | abhijjhādomanassan (?) | ? |  |
> | avitakkaavicārampi (?) | ? |  |
> | avitakkavicāramattampi (?) | ? |  |
> | savitakkasavicārampi (?) | ? |  |
> | vicāramatta | adj | with a measure of examination; with a modicum of exploration |
> | maññantī (?) | ? |  |
> | ovadita | pp | advised; instructed; taught; admonished |
> | phāsuṁyeva (?) | ? |  |
> | avitakkampi (?) | ? |  |
> | upekkhāsahagatampi (?) | ? |  |
> | sātasahagatampi (?) | ? |  |
> | nippītikampi (?) | ? |  |
> | sappītikampi (?) | ? |  |
> | nāmāhaṁ | sandhi | I truly; I definitely |
> | mudita | pp | happy; glad |
> | karuṇa | adj |  |
> | kappeti | pr | prepares; arranges; forms; fashions; constructs |
> | susaṇṭhita | adj | well established (in); well settled (in); firmly fixed (in) |
> | yamahaṁ | sandhi | whatever I; which I; that I |
> | ovāda | masc | advice; instruction encouragement; exhortation |
> | brahmacariyapariyosāna | nt | perfection of the holy life; ideal of the spiritual path; cu… |
> | tadanuttaraṁ | sandhi | that unsurpassed |
> | dāyāda | masc | heir (of); inheritor (of) |
> | pabbajan (?) | ? |  |
> | yassatthāya | masc | for which purpose; for which reason |
...
> | nacirasseva | sandhi | after only a short time |
...
> | avicāra | adj | free from discursive thought |
> | savicāra | adj | with management; with planning |
> | cetovimut (?) | ? |  |
...
> | padakkhiṇa | adj | auspicious; favourable; reverential; respectful; upright |
> | arahati | pr | is worthy (of); deserves; merits |
> | ājānāti | pr | knows; understands |
<!-- pali-nlp:vocab-end -->
