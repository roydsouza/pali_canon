...
tags:
  ...
  - meditation
parallels:
  - 'AN 8.74 (an8.74) · Pali · Dutiyamaraṇassatisutta'
---
...
> |---|---|---|
> | vihātabba | ptp | should be lived (with); should be continued (with) |
> | appaṭivāniñca (?) | ? |  |
> | ussoḷhiñca (?) | ? |  |
> | ussāhañca (?) | ? |  |
> | vāyāmañca (?) | ? |  |
> | ādittasīsa | masc | whose head is on fire; with a blazing head |
> | ādittacela | adj | whose clothes are on fire; with blazing garments |
> | paṭisañcikkhitabba | ptp | should be reflected; should be considered; should be discern… |
> | satthaka | nt |  |
> | upakkhalitvā | abs | having tripped; having stumbled |
> | vicchika | masc | scorpion |
> | patihita | pp | returned; come again |
...
> | satiñca (?) | ? |  |
> | nibbāpana | nt | (of fire) extinguishing; quenching; putting out |
> | papatati | pr | falls (from); falls away (from); falls off |
> | giñjakāvasatha | masc | brick house |
> | cela | nt | cloth; sheet |
> | appaṭivānī | masc | indefatigably; zeal; tireless determination; resolute intent… |
> | ussoḷhi | fem | endurance; strenous exertion |
> | ussāha | masc | effort; activity; perseverance; strenuous and continuous exe… |
> | kuppati | pr | is angered (by); is provoked (by); is irritated (by); is ann… |
> | byāpajjati | pr | hates; dislikes; is repelled (by); is hostile (to) |
> | tesaṁyeva | sandhi | of those very; of those exact |
> | ḍaṁsati | pr | bites; stings |
...
> | adhimatta | adj | extreme; excessive; utmost; intense |
> | pitta | nt | bile |
...
> | paccavekkhamāna | prp | reviewing; reflecting (on); looking (at) |
> | mamassa | sandhi | it could be my; it would be for me |
> | divasa | nt | day |
> | paṭisañcikkhati | pr | reflects; considers; discerns |
> | sīsa | nt | head |
