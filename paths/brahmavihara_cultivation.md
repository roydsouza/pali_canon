...
```mermaid
graph TD
    A["Purifying the Mind & Cloth Simile <br> (MN 7)"] --> B["Loving-Kindness & Rebirth <br> (AN 4.125-126)"]
    B --> C["Boundless Radiance & Liberation <br> (DN 13)"]
    C --> D["Integration with Awakening Factors <br> (SN 46.54)"]
    D --> E["Daily Benefits & Lay Practice <br> (AN 11.15 / Snp 1.8)"]
