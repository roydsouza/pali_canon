...
```mermaid
graph TD
    A["Directing Attention & Removing Taints <br> (MN 2)"] --> B["Contemplating the Sense Bases <br> (MN 148)"]
    B --> C["Contemplating Feeling & Sensation <br> (SN 36)"]
    C --> D["Contemplating the Four Material Elements <br> (MN 28)"]
    D --> E["Deepening Element Analysis <br> (MN 140)"]
