...
```mermaid
graph TD
    A["Ethical Foundation & Effacement <br> (MN 8)"] --> B["Overcoming Obstacles & Imperfections <br> (MN 128)"]
    B --> C["Stabilizing Absorption <br> (AN 9.35)"]
    C --> D["Brief Practical Integration <br> (AN 8.63)"]
    D --> E["Cessation & Freedom <br> (AN 9.34)"]
    E --> F["Insight & Taint-Drying <br> (AN 9.36 / MN 111)"]
