...
```mermaid
graph TD
    A["Lay Householder Foundations <br> (AN 8.54)"] --> B["Precepts & Benefits <br> (AN 4.99)"]
    B --> C["The Four Types of Persons <br> (MN 51)"]
    C --> D["The Simile of the Elephant Footprint <br> (MN 27)"]
    D --> E["The Monastic Gradual Training <br> (DN 2)"]
