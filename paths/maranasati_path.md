...
```mermaid
graph TD
    A["Urgency & Daily Reflection <br> (AN 6.19)"] --> B["Immediate Present Attention <br> (AN 6.20)"]
    B --> C["Boundless Directions Contemplation <br> (AN 8.73)"]
    C --> D["Facing Death with Mindfulness <br> (SN 47.13)"]
